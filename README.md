...
| **Sprint 4** | **US-24** | **Landing Page Segmentada** | **UT-39** | **Enrutamiento Landing-App** | **Conectar los botones "Ingresar" y "Registrarse" de la Landing Page con las rutas del Frontend de la aplicación.** | **2** | **Jose** | **To Do** |
