...
| -------- | ------------------------ | ---- | -------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| EP01     | Registro y Autenticación | US01 | Registro de usuario                    | Como usuario, quiero registrarme en la plataforma para crear mi cuenta en Smart Stay.               | - Escenario 1: Registro exitoso  <br> Dado que el usuario accede al formulario de registro, <br> Cuando completa los campos requeridos y presiona “Crear cuenta”, <br> Entonces el sistema registra al usuario y muestra un mensaje de bienvenida.                                                                                                                                 |
| EP01     | Registro y Autenticación | US02 | Inicio de sesión                       | Como usuario registrado, quiero iniciar sesión en la plataforma para acceder a mis funcionalidades. | - Escenario 1: Inicio de sesión exitoso <br> Dado que el usuario ya está registrado, <br> Cuando ingresa sus credenciales válidas, <br> Entonces el sistema lo redirige a su panel. <br><br> - Escenario 2: Inicio fallido <br> Dado que el usuario ingresa credenciales incorrectas, <br> Cuando presiona “Iniciar sesión”, <br> Entonces el sistema muestra un mensaje de error. |
| EP01     | Registro y Autenticación | US03 | Cierre de sesión                       | Como usuario, quiero cerrar sesión para mantener mi cuenta segura.                                  | - Escenario 1: Cierre de sesión exitoso <br> Dado que el usuario está logueado, <br> Cuando selecciona “Cerrar sesión”, <br> Entonces el sistema finaliza la sesión y lo redirige al login.                                                                                                                                                                                        |
| EP01     | Registro y Autenticación | TS01 | Validar campos de registro en frontend | Como desarrollador, quiero validar los campos del formulario para evitar errores de entrada.        | - Escenario 1: Validación de campos vacíos <br> Dado que el usuario intenta registrarse sin completar todos los campos, <br> Cuando presiona “Crear cuenta”, <br> Entonces el sistema muestra un mensaje de validación.                                                                                                                                                            |
| EP01     | Registro y Autenticación | TS02 | Manejar respuestas de autenticación    | Como desarrollador, quiero manejar respuestas del backend en el login/registro.                     | - Escenario 1: Respuesta exitosa <br> Dado que el backend devuelve un estado 200 OK, <br> Cuando el frontend recibe la respuesta, <br> Entonces muestra acceso permitido. <br><br> - Escenario 2: Respuesta de error <br> Dado que el backend devuelve un error 401, <br> Cuando el frontend recibe la respuesta, <br> Entonces muestra un mensaje de credenciales inválidas.      |
...
| ID Épica | Épica              | ID   | Título                                       | Descripción                                                                          | Criterios de Aceptación                                                                                                                                                                                                    |
| -------- | ------------------ | ---- | -------------------------------------------- | ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| EP02     | Búsqueda y Reserva | US04 | Buscar propiedades                           | Como usuario, quiero buscar propiedades filtrando por ciudad, fechas y precio.       | - Escenario 1: Búsqueda con filtros <br> Dado que el usuario accede al buscador, <br> Cuando ingresa ciudad y rango de fechas, <br> Entonces el sistema muestra las propiedades disponibles.                               |
| EP02     | Búsqueda y Reserva | US05 | Reservar propiedad                           | Como usuario, quiero reservar una propiedad seleccionada para asegurar mi estadía.   | - Escenario 1: Reserva exitosa <br> Dado que el usuario selecciona una propiedad, <br> Cuando completa los datos de reserva y presiona “Confirmar”, <br> Entonces el sistema registra la reserva y muestra un comprobante. |
| EP02     | Búsqueda y Reserva | TS03 | Validar disponibilidad de fechas en frontend | Como desarrollador, quiero que el frontend muestre disponibilidad según la búsqueda. | - Escenario 1: Fechas disponibles <br> Dado que el usuario selecciona un rango de fechas, <br> Cuando la propiedad está libre, <br> Entonces el sistema muestra la opción “Reservar”.                                      |

**EP03 – Panel del Propietario**

| ID Épica | Épica                 | ID   | Título                            | Descripción                                                                      | Criterios de Aceptación                                                                                                                                                                                             |
| -------- | --------------------- | ---- | --------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| EP03     | Panel del Propietario | US06 | Publicar propiedad                | Como propietario, quiero registrar mi propiedad para ofrecerla en la plataforma. | - Escenario 1: Registro exitoso de propiedad <br> Dado que el propietario accede al panel, <br> Cuando completa el formulario de nueva propiedad, <br> Entonces el sistema guarda y muestra la propiedad publicada. |
| EP03     | Panel del Propietario | US07 | Ver reservas recibidas            | Como propietario, quiero ver una lista de reservas recibidas para gestionarlas.  | - Escenario 1: Visualización de reservas <br> Dado que el propietario tiene reservas, <br> Cuando accede al panel, <br> Entonces el sistema muestra una lista con detalles de cada reserva.                         |
| EP03     | Panel del Propietario | TS04 | Validar formulario de publicación | Como desarrollador, quiero validar los campos al registrar una propiedad.        | - Escenario 1: Validación de campos incompletos <br> Dado que el propietario deja campos vacíos, <br> Cuando intenta registrar la propiedad, <br> Entonces el sistema muestra mensajes de validación.               |


**EP04 – Gestión de Pagos y Reportes**

| ID Épica | Épica            | ID   | Título                            | Descripción                                                                                | Criterios de Aceptación                                                                                                                                                                                                |
| -------- | ---------------- | ---- | --------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| EP04     | Pagos y Reportes | US08 | Ver métodos de pago               | Como usuario, quiero visualizar los métodos de pago disponibles para completar mi reserva. | - Escenario 1: Visualización de métodos <br> Dado que el usuario accede a la sección de pago, <br> Cuando selecciona “Métodos de pago”, <br> Entonces el sistema muestra tarjetas, transferencias u otros disponibles. |
| EP04     | Pagos y Reportes | US09 | Generar comprobante de reserva    | Como usuario, quiero descargar un comprobante de mi reserva para tener un respaldo.        | - Escenario 1: Descarga de comprobante <br> Dado que el usuario tiene una reserva confirmada, <br> Cuando solicita el comprobante, <br> Entonces el sistema genera un archivo PDF con los detalles.                    |
| EP04     | Pagos y Reportes | TS05 | Mostrar mensajes de error de pago | Como desarrollador, quiero manejar los errores de pago para informar al usuario.           | - Escenario 1: Pago rechazado <br> Dado que el usuario intenta pagar, <br> Cuando el sistema recibe rechazo, <br> Entonces muestra “Pago no procesado, intente nuevamente”.                                            |
